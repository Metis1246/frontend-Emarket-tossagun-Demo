              ...
              <div className="w-full">
                <div className="product-list">
                  {sortData().map((product, index) => (
                    <div
                      key={index}
                      className="relative flex h-18rem md:h-22rem "
                    >
                      <div className="w-full border-1 surface-border bg-white flex flex-column ">
                        ...
                        <div className="h-full px-2 flex flex-column product-content mt-1 font-normal">
                          <h4 className="m-0 p-0 font-normal two-lines-ellipsis leading-tight font-bold">
