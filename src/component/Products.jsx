...
function Products({ data, startIndex }) {
  ...
  const productTemplate = (product) => {
    return product ? (
      <div
        className="carousel-product-item h-full border-1 surface-border mx-1 bg-white flex flex-column "
        style={{
          position: "relative",
      ...
      >
        <p
          className={`w-fit mt-2 px-2 font-normal ${
        ...
        <div className="h-full flex flex-column justify-content-between pt-">
          <h4 className="m-0 font-semibold two-lines-ellipsis">
